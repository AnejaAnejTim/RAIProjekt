...
import { faAppleAlt, faCarrot, faCheese, faEgg, faGlassWhiskey } from '@fortawesome/free-solid-svg-icons';
...
function Fridge() {
    ...
    const foodItems = [
        { icon: faAppleAlt, label: 'Apple' },
        { icon: faCarrot, label: 'Broccoli' },
        { icon: faCheese, label: 'Cheese' },
        { icon: faEgg, label: 'Eggs' },
        { icon: faGlassWhiskey, label: 'Milk' },
    ];
        ...
        <div className="position-relative">
                                ...
                                {foodItems.map((item, idx) => (
                                    ...
                                    >
                                        ...
                                        <input
                                            ...
                                            onChange={() => handleItemSelection(item.label)}
                                            style={{
                                                position: 'absolute',
                                                opacity: 0,
                                                pointerEvents: 'none',
            ...
            >
                {showMenu && (
                    ...
                    >
                        <div className="fw-bold mb-2" style={{ fontSize: '1rem', borderBottom: '1px solid #ccc', paddingBottom: '5px' }}>
                            Seznam sestavin
                        </div>
